...
class AddPrivateServersModal extends React.Component {
    state = {
        name: '',
        color: '#FFFFFF',
        host: '',
    ...
    render() {
        return (
            <ModalWindow title="Ajouter un serveur privé" close={this.props.closeModal}>
                <div style={{
                    display: 'flex',
...
export default AddPrivateServersModal;