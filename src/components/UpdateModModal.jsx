                    ...
                    {this.state.started ? (
                        <div className="download">
                            {this.state.progress.progress ? (
                                <>
                                    <div className="info">
                                        {this.state.progress.downloaded === this.state.progress.total ? "Mise à jour en cours..." : (<>Téléchargé : {this.state.progress.downloaded}/{this.state.progress.total}</>)}
                                    </div>
                        ...
                        <div className="confirm-box">
                            <div className="confirm-message">
                                Voulez-vous vraiment mettre à jour le mod <span>{data.name}</span> ?
                            </div>
